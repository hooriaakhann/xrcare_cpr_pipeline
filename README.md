...
|---|---:|---:|---:|---:|
| video1 | 90.00 | 92.71 | +2.71 | 0.553 |
| video2 | 69.23 | 68.01 | -1.22 | 0.467 |
| video3 | 105.88 | 103.71 | -2.17 | 0.574 |
| video4 | 72.00 | 69.33 | -2.67 | 0.500 |
| video9 | 94.74 | 97.62 | +2.88 | 0.448 |
| video10 | 100.00 | 99.79 | -0.21 | 0.669 |

**MAE = 1.976 CPM (95% CI [1.159, 2.664]), RMSE = 2.199, mean signed error = -0.112**
(essentially unbiased). Every video within ~1-4% relative error of GT.
...
`hybrid.ablation.run_ablation_comparison`.
